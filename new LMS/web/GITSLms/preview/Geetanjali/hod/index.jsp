            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <h1 class="page-title">  HOD Dashboard
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                            ...
                            <div class="col-lg-6 col-xs-12 col-sm-12">
                                     <div class="portlet light profile-sidebar-portlet ">
                                        ...
                                        <div class="profile-userpic">
                                            <img src="../images/<%=session.getAttribute("image")%>" class="img-responsive" alt=""> </div>
                                        <!-- END SIDEBAR USERPIC -->
                                        <!-- SIDEBAR USER TITLE -->
                                        <div class="profile-usertitle">
                                            <div class="profile-usertitle-name"><%=session.getAttribute("name")%> </div>
                                            <div class="profile-usertitle-job"> <%=session.getAttribute("department")%></div>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div id="quickstatus">
                                ...
                                <jsp:include page="quickstatustable.jsp"/>
                            </div>
                                                <div id="quick5pending">
                                                                <jsp:include page="quickpendingtable.jsp"/>
                                                </div>
                        </div>
