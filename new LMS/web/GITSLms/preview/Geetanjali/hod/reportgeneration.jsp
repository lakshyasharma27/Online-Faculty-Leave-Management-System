    ...
    <head>    <link rel="stylesheet" href="../js/alertify.bootstrap.css">
        ...
        <script type="text/javascript">
            ...
            function weekly()
            {
                ...
                alert(value);
               /* $.ajax({
                    url: "reportgenerationtable.jsp",
                    type: "post",
                    data : value,
                    cache: false,
                    success: function()
                    {    //var page=$(this).attr('href');
                        $('#report').load('reportgenerationtable.jsp');
                        alert("hello");
            ...
            function monthly()
            {
                ...
                var d = new Date();
                var ts = d.getTime();
                var twelveDays = ts - (30 * 24 * 60 * 60 * 1000);
                d.setTime(twelveDays);
                var dd = d.getDate();
                var mm = d.getMonth() + 1;
                var yyyy = d.getFullYear();
            ...
            function yearly()
            {
                ...
                var d = new Date();
                var ts = d.getTime();
                var twelveDays = ts - (365 * 24 * 60 * 60 * 1000);
                d.setTime(twelveDays);
                var dd = d.getDate();
                var mm = d.getMonth() + 1;
                var yyyy = d.getFullYear();
            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <h1 class="page-title">  Report Generation
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <select class="form-control select2me" id="designation"  name="designation">
                                                            <option value="HOD">select name</option>
                                                            <option value="Professor">Girish Ameta</option>
                                                            <option value="Associate Professor">Raghuveer Sir</option>
                                                            <option value="Assistant Professor">Himanshu Singh</option>
                                                            <option value="Technical Assistant">Piyush</option>
                                                            <option value="Lab Peon">Ruchi Vyas</option>
                            ...
                            <div class="col-md-3">
                                <select class="form-control select2me" id="designation"  name="designation">
                                                            <option value="HOD"> Select Department</option>
                                                            <option value="Professor">CSE</option>
                                                            <option value="Associate Professor">ME</option>
                                                            <option value="Assistant Professor">EE</option>
                                                            <option value="Technical Assistant">EC</option>
                                                            <option value="Lab Peon">AE</option>
                        ...
                        <div class="row" >
                            ...
                            <div class="col-md-3">
                                ...
                                <div ><button id="weekly" onclick="weekly()"> Weekly </button>
                                    <button id="Monthly" onclick="monthly()">Monthly </button>
                                    <button id="yearly" onclick="yearly()"> Yearly </button>
                                </div>                                     
                            ...
                            <div class="col-md-8">
                                ...
                                <button id="yearly" onclick="between()"> Go </button>
