          ...
          <script type="text/javascript">
                                 ...
                                 function addrow()
                                               ...
                                               {   var s=temps+"&nbsp;semester";
                                                   $('#'+semester).append('<option value='+s+'>'+s+'</option>');
                                               }
                                               var tempslot=1;
                                                   ...
                                                   $('#'+slot).append('<option value='+sl+'>'+sl+'</option>');
                                                     ...
                                                     $.ajax({
                                                            ...
                                                            {  var i=0;
                                                              ...
                                                              // $('#'+substitute).append('<li onclick="helpme(this)"' +'id=btSubmit value='+this['appid']+'><span class="photo"><img src="../assets/pages/media/profile/profile_user.jpg" class="img-circle" alt=""> </span><span class="from">'+this['name']+'</span><span class="time">16min</span><span class="message">Has applied for leave</span></li><hr>');
                                                            });
                                                            },
                                                            error:function()
                                                            {
                                 ...
                                 function subs(){alert(i);}
                                    ...
                                    //window.location.replace("sar.jsp?array="+temp);
                                     window.location.replace("leavewithsubstitution.jsp?name="+name+"&email="+email+"&designation="+designation+"&department="+department+"&leavetype="+leavetype+"&reason="+reason+"&datefrom="+datefrom+"&dateto="+dateto+"&array="+temp);
                                     }
                                        ...
                                        <form action="applyleavebean.jsp" id="form_sample_3" class="form-horizontal" method="POST">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="name" value="<%=session.getAttribute("name")%>" readonly data-required="1" class="form-control" /> </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="email" name="email" value="<%=session.getAttribute("email")%>" readonly class="form-control" placeholder="Email Address"> </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="designation" value="<%=session.getAttribute("designation")%>" readonly data-required="1" class="form-control" /> </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="department" data-required="1" value="<%=session.getAttribute("department")%>" readonly class="form-control" /> </div>
                                                </div>                                                
                                                <div class="form-group">
