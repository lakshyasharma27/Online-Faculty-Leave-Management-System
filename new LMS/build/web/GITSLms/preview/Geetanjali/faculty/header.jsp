...
<!-- BEGIN HEADER -->
   ...
   // var f=document.form;
     alert("javascript edit"+id);  
     //  window.location.replace("../editprofile.jsp?id="+id);
     window.location.replace("../editprofile.jsp?id="+id);
}
                    ...
                    <div class="top-menu">
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src="../images/<%=session.getAttribute("image")%>" />
                                    <span class="username username-hide-on-mobile"> <%=session.getAttribute("name")%> </span>
                                    
                                    <i class="fa fa-angle-down"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-default">
                                    <li>
                                        <a class="hello" onclick="editRecord1(<%=session.getAttribute("eid")%>);">
