                                        ...
                                        <div class="tab-content">
                                                ...
                                                <!-- BEGIN: Comments -->
                                                 <%
                                                                try {
                                                                    ...
                                                                    PreparedStatement ps = c.prepareStatement("select * from leaveapplication where department=? and name<>? and status="+"'recommended' order by appid DESC LIMIT 5 ");
                                            ...
                                            <div class="tab-pane" id="portlet_comments_2">
                                                ...
                                                <%
                                                                try {
                                                                    Connection c=com.dbconnection.Loadconnection.getConnection();
                                                                    PreparedStatement ps = c.prepareStatement("select * from leaveapplication where status="+"'not recommended' order by appid DESC LIMIT 5 ");
