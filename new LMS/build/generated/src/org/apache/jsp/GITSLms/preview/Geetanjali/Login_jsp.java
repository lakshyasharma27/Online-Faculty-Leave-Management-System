package org.apache.jsp.GITSLms.preview.Geetanjali;
...
{}
   ...
   response.sendRedirect("loginbean.jsp");} 
      ...
      out.write("        <title>LMS| User Login </title>\n");
      ...
      out.write("    <!-- END HEAD -->\n");
      out.write("\n");
      out.write("    <body class=\" login\" style=\"background-image:url(assets/pages/img/login/geetanjali.jpg)\">\n");
      out.write("       \n");
